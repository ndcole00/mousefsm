            ...
            while trialend == 0%~strcmp(rcvd2,'E'); % it will send an E when trial ends
                ...
                if fsm.ard.BytesAvailable
                    ...
                    if rcvd2 == 'E';
                        ...
                        fsm.changelist_ori = [fsm.changelist_ori repmat(fsm.orientationchange,1,length(changelist))];
...
changelist = repmat({'refractorylick'},1,lt1);
if isnan(RT);changelist = [changelist 'miss'];else changelist = [changelist 'correct'];end
