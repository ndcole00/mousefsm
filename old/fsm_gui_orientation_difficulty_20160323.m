            ...
            while trialend == 0%~strcmp(rcvd2,'E'); % it will send an E when trial ends
                ...
                if fsm.ard.BytesAvailable
                    ...
                    if rcvd2 == 'E';
                        ...
                        [fsm.RT(fsm.trialnum), fsm.FAT{fsm.trialnum}, fsm.refractoryLT{fsm.trialnum}] = findrectiontime(fsm.triallog{fsm.trialnum});
                        updateRTplot
...
function [RT,FAT,refractoryLT] = findrectiontime(triallog)
