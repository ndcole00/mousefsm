...
function fsm_gui_orientation_difficulty_reward_draft()
close all
...
%     end
    ...
    %  spd in   spd out     lick    Tup       Timer   digiOut
        ...
        15          15       7      7         .115     Cont            ;...% state 15 delay - when need to autoreward
    ...
    switch rcvd
        ...
        case 'startingFSM'
            ...
            while trialend == 0%~strcmp(rcvd2,'E'); % it will send an E when trial ends
                ...
                stim_machine_LR_orientation_freeze_sound20160420
