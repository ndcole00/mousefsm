function stim_machine_LR_contrast_sound
...
% 1: cueL, 2:cueR, 3: stim both sides, 4:contrast change both sides, 5:Sound
% 6: pause - punishment
...
switch trigg
    ...
    case 1 % cue vis
        fsm.grayscreen = 0;fsm.soundon = 0;
        contrastL = contrast;
        contrastR = contrast;
    ...
    case 2 % cue sound
        ...
        if ~fsm.soundon; 
            ...
            %sound(fsm.snd(1:length(fsm.snd)/4));%%beep 1/4th duration
        end
        contrastL = 0;
        contrastR = 0;
    ...
    case 5 % sound, and don't change contrast
        fsm.grayscreen = 0;
        if ~fsm.soundon; 
            fsm.soundon = 1; 
            PsychPortAudio('Start', fsm.pahandle);
