% 20160420 - added photodiode

function stim_machine_LR_orientation_freeze_sound
...
if strcmp (MachineUsed,'BEHAVCOMP')
PhotoDiode = 1;
Screen('FillRect', fsm.winR, 0, [0 0 100 100] );% white rectangle for photodiode
else
PhotoDiode =0;
end
...
%         end
    ...
    case 3 % Stim on both sides
        ...
        %vbl = Screen('Flip', fsm.winL, vbl + 0.5 * fsm.ifi,[],1,1);
       if PhotoDiode == 1;
           Screen('FillRect', fsm.winR, 255, [0 0 100 100] )% white rectangle for photodiode
       end
           Screen('Flip', fsm.winL, [],[],1,1);
