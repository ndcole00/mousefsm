...
fsm.s.addDigitalChannel('Dev1', 'Port0/Line0:4', 'InputOnly');
...
%     
    ...
    %gabortex1 = CreateProceduralGabor(fsm.fsm.winL, tw, th, 0, [0.5 0.5 0.5 0.0],1,.5);
    %gabortex2 = CreateProceduralGabor(fsm.winR, tw, th, 0, [0.5 0.5 0.5 0.0],1,.5);
    fsm.gabortex1 = CreateProceduralGabor(fsm.winL, tw, th, 0, [0.5 0.5 0.5 0.0]);
    fsm.gabortex2 = CreateProceduralGabor(fsm.winR, tw, th, 0, [0.5 0.5 0.5 0.0]);
    ...
    Screen('DrawTexture', fsm.winL, fsm.gabortex1, [], [], tilt, [], [], [], [], kPsychDontDoRotation, [fsm.phase, freq, sc, contrast, aspectratio, 0, 0, 0]);
    Screen('DrawTexture', fsm.winR, fsm.gabortex2, [], [], tilt, [], [], [], [], kPsychDontDoRotation, [fsm.phase, freq, sc, contrast, aspectratio, 0, 0, 0]);
