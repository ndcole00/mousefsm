function fsm_gui_orientation_difficulty_closeloopIMG()
close all
clearvars -global fsm
global fsm
% Initialise
fsm.comport = num2str(GetComPort ('Teensy USB Serial'));
fsm.savedir = 'D:\DATA\IO_data\FSMdata\';
fsm.token = 'M100_B1';
fsm.fname = '';
fsm.spdrnghigh = 110;
fsm.spdrnglow = -10;
...
stim_machine_LR_init_closeloopIMG
    ...
    switch rcvd
        ...
        case 'startingFSM'
            ...
            while trialend == 0%~strcmp(rcvd2,'E'); % it will send an E when trial ends
                ...
                stim_machine_LR_orientation_closeloop_freezetopunishIMG
