function fsm_gui_orientation_sound()
close all
...
% Sound + ori?
fsm.handles.soundvis = uicontrol('Parent',fsm.handles.f,'Units','normalized','Style','checkbox',...
    'Position', [0.35 0.25 0.12 0.04],'String','Sound + Ori?',...
    'Value',1,'FontSize',10);
...
while keeprunning 
    ...
    %  spd in   spd out     lick    Tup       Timer   digiOut
        ...
        5           1        lok2    10        stimT    Stim            ;...% state 5 stim on, wait for orientation change
        6           6        7       7         waitT    Cont            ;...% state 6 orientation change, wait for lick
    ...
    switch rcvd
        ...
        case 'startingFSM'
            ...
            while trialend == 0%~strcmp(rcvd2,'E'); % it will send an E when trial ends
                ...
                stim_machine_LR_orientation_sound
...
% orientation change 5 to 6, lick 6 to 7
