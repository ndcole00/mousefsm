function stim_machine_init_running_in_dark

global fsm


fsm.s = daq.createSession('ni');
% fsm.s.addDigitalChannel('Dev1', 'Port0/Line3', 'InputOnly');% make it an input line
% fsm.s.addDigitalChannel('Dev1', 'Port2/Line3:4', 'InputOnly');%
