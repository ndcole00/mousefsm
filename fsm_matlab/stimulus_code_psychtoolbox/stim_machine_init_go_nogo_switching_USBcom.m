...
try
    ...
    if 1
        ...
        elseif strcmp(getenv('computername'),'BEHAVIOUR-BOX-A') % Box A
            load ('C:\Users\Behaviour Only A\Documents\MATLAB\mousefsm\gamma correction\gamma correction mesoscope\calib20170817_DellU2715H_bright50_cont50.mat')
        ...
        elseif strcmp(getenv('computername'),'BEHAVIOUR-BOX-C') % Box C
            load ('C:\Users\Behaviour Only One\Documents\MATLAB\mousefsm\gamma correction\gamma correction mesoscope\calib20170817_DellU2715H_bright50_cont50.mat')
        elseif strcmp(getenv('computername'),'BEHAVIOUR-BOX-D') % Box D
            load ('C:\Users\Behaviour Only D\Documents\MATLAB\mousefsm\gamma correction\gamma correction mesoscope\calib20170817_DellU2715H_bright50_cont50.mat')
        end
