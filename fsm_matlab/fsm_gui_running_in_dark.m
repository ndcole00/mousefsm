% 20160901 Just run for certain duration to get a reward

function fsm_gui_running_in_dark()
...
fsm.TeensyCode = 'fsm_running_in_dark.ino';
...
% start serial port
fsm.ard=serial(fsm.comport,'BaudRate',9600); % create serial communication object on port COM
...
stim_machine_init_running_in_dark
...
%     choose_stim % decide which stimlus to give 
    ...
    spdT  = str2num(get(fsm.handles.Tspeedmaintain,'string'));
