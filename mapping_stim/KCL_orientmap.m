...
%     end
    ...
    for i=1:length(FreqSpatial),
        ...
        gbc = 255*temp_gammacon_r303(gb,'lum2rgb'); % figure('Units','centimeters','Position',[98 10 14 9]);imagesc(gbc);colorbar;
